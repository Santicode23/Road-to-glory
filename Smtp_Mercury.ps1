...
Write-Host "`nDescargando e instalando OpenJDK 17 (Temurin)..."
...
Write-Host "`nIniciando Apache James (esperando $CLI_TIMEOUT segundos para estabilizar)..."
Start-Process -NoNewWindow -FilePath "$JAMES_DIR\bin\james.bat"
Start-Sleep -Seconds $CLI_TIMEOUT

# CONFIGURAR DOMINIO Y USUARIO
Write-Host "`nAgregando dominio $DOMAIN y usuario de prueba..."
& $CLI AddDomain $DOMAIN
& $CLI AddUser "prueba@$DOMAIN" "12345"

# ABRIR PUERTOS EN EL FIREWALL
Write-Host "`nAbriendo puertos SMTP (25), POP3 (110) e IMAP (143) en el firewall..."
$ports = @(25, 110, 143)
...
Write-Host "`nRegistrando Apache James como servicio..."
...
Write-Host "`nPuedes probar la conexión desde otra máquina con Thunderbird o SquirrelMail."
